...
import com.alim.cleanmaster.AppLockActivity;
...
/**
 * Created by zeeshan on 6/17/2016.
 */
...
public class AppDetails {
    ...
    private ArrayList<PackageInfoStruct> getInstalledApps(boolean getSysPackages) {
        ...
        MainActivity.packageInfo = res;
        SplashScreen.packageInfo = res;
      //  AppLockActivity.setPackageInfos(res);
        return res;
    }
