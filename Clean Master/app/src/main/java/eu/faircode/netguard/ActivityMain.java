...
public class ActivityMain extends AppCompatActivity implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    public static final String ACTION_RULES_CHANGED = "com.cachecaleener.cachecleaner.ACTION_RULES_CHANGED";
    public static final String ACTION_QUEUE_CHANGED = "com.cachecaleener.cachecleaner.ACTION_QUEUE_CHANGED";
    ...
    protected void onCreate(Bundle savedInstanceState) {
       Log.i(TAG, "Create version=" + Util.getSelfVersionName(this) + "/" + Util.getSelfVersionCode(this));
        ...
        mProgresBar = findViewById(R.id.mProgressBar);
        running = true;
